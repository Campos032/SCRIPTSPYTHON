# Input será uma string podendo ter números, letras ou qualquer tipo de caractere, isnumeric é um método usado para
# verificar se o que tem ná str pode ser convertido em apenas números inteiros, se tiver letras e número isso não poderá
# acontecer e retornara falso no programa
...
# Tem outros tipos de métodos também, que podem ser usadas em outras oportunidades, lembrando que estamos usando os
