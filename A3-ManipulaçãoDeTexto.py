...
# frase2.count('o') retorna a quantidade do parâmetro que você utilizou e frase2.count('o',0,13) vai mostrar quantas
# letras O tem de 0 a 13 exceto 13
...
print(
    frase2.strip())  # strip(rstrip removerá apenas os espaços da esquerda e lstrip removerá apenas os sepaços da
# esquerda) remove todos os espaços inúteis em uma str, tanto no começo da quanto no final
